    ...
    <div>
      ...
      <div className='bg-blue-400 h-screen pt-2'>
        ...
        <div className='bg-white md:w-[60%] sm:w-[80%] w-[90%] mx-auto md:p-5 p-4 rounded-md mb-6'>
          <h1 className='md:text-4xl text-2xl font-semibold mb-2' >{data && data.name}</h1>
          <p className='text-[15px] md:text-[18px] text-gray-500'>Email - {data && data.email}<span className='font-semibold'></span></p>
          <p className='text-[15px] md:text-[18px] text-gray-500'>phone - {data && data.phone}<span className='font-semibold'>7907144673</span></p>
          <p className='text-[15px] md:text-[18px] text-gray-500'>DOB - {data && data.dob}<span className='font-semibold'>13/06/2003</span></p>
          <p className='text-[15px] md:text-[18px] text-gray-500'>State -{data && data.state} <span className='font-semibold'>Kerala</span></p>
          <p className='text-[15px] md:text-[18px] text-gray-500'>District -{data && data.district} <span className='font-semibold'>Ernakulam</span></p>
          <p className='text-[15px] md:text-[18px] text-gray-500'>Address - {data && data.address}<span className='font-semibold'>House no:001 vytilla , ernakulam</span></p>
        </div>
